...
@Constraint(validatedBy = {ValidDoubleRange.Validator.class})
public @interface ValidDoubleRange {
    ...
    class Validator implements ConstraintValidator<ValidDoubleRange, Double> {
        ...
        @Override
        public void initialize(ValidDoubleRange annotation) {
